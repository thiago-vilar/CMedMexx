...
namespace WebAPI.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "DoctorId");
                    table.ForeignKey(
                        name: "FK_Appointment_RoomRentals_RoomRentalId",
                        column: x => x.RoomRentalId,
                        principalTable: "RoomRentals",
                        principalColumn: "RoomRentalId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Appointment_Users_PatientUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointment_PatientUserId",
                table: "Appointment",
                column: "PatientUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Appointment_RoomRentalId",
                table: "Appointment",
                column: "RoomRentalId");
